...
export const CAD_EXPORT_GUIDE: Record<string, string> = {
  ".dwg": "AutoCAD: File → Export → Other Formats → PNG/TIFF",
  ".dxf": "AutoCAD/LibreCAD: File → Export → PNG or JPEG",
  ".rvt": "Revit: File → Export → Images and Animations → Image",
  ".rfa": "Revit: Open family → File → Export → Image",
  ".skp": "SketchUp: File → Export → 2D Graphic → PNG",
  ".ifc": "BIMvision (free): open file → top-down view → screenshot",
  ".dgn": "MicroStation: File → Export → Raster → PNG",
  ".3dm": "Rhino: File → Export Selected → PNG",
};
